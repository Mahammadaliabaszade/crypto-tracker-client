  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F0F4FF', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div className="card" style={{ width: '100%', maxWidth: '400px', padding: '40px' }}>
        ...
        <h2 style={{ fontSize: '20px', fontWeight: '500', color: '#0F172A', marginBottom: '6px' }}>Create an account</h2>
        <p style={{ fontSize: '14px', color: '#94A3B8', marginBottom: '28px' }}>Start tracking your crypto today</p>
        ...
        <button className="btn-primary" onClick={handleRegister} disabled={loading} style={{ width: '100%', padding: '11px' }}>
